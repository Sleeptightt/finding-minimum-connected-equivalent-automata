...
public class MainController {
    ...
    void find_automata(ActionEvent event) {
    	...
    	if(type.equals("Mealy")){
    		fillMealyAutomata();
    	     ...
    	     ArrayList<Integer>[] end = algorithm.MealyPartition(mealy);
    	     showMinimunAutomata(end, inputAlphabet.getText().split(","), mealy);
    	     String ans = "";
    ...
    public void showMinimunAutomata(List<Integer>[] end, String[] input, Machine automata) {
